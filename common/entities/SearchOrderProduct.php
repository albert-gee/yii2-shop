...
use albertgeeca\shop\common\entities\OrderProduct;

/**
 * SearchOrderProduct represents the model behind the search form about `albertgeeca\shop\common\entities\OrderProduct`.
