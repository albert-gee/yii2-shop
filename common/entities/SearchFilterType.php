...
use albertgeeca\shop\common\entities\FilterType;

/**
 * SearchFilterType represents the model behind the search form about `albertgeeca\shop\common\entities\FilterType`.
 */
